...
game.o : ./src/game.cpp ./src/game.h ./src/utils/printController.h ./src/utils/models.h ./src/utils/logger/logger.h ./utils/data_reader/dataReader.h
	...
	-o ./src/game.o \
	-c ./src/game.cpp
printController.o : ./src/utils/printController.cpp ./src/utils/printController.h ./src/utils/logger/logger.h
	g++ \
	-o ./src/utils/printController.o \
	-c ./src/utils/printController.cpp 
models.o : ./src/utils/models.cpp ./src/utils/models.h ./src/utils/logger/logger.h
	g++ \
	-o ./src/utils/models.o \
	-c ./src/utils/models.cpp 
dataReader.o : ./src/utils/data_reader/dataReader.cpp ./src/utils/data_reader/dataReader.h ./src/utils/logger/logger.h
	g++ \
